...
using PlanB.Infrastructure;
using PlanB.Infrastructure.Data;
using PlanB.Module.Core.Areas.Core.Viewmodels;
...
namespace PlanB.Module.Core.Services
{
    public class ThemeService : IThemeService
    {
        ...
        public ThemeService(IConfiguration configuration, IRepositoryWithTypedId<AppSetting, string> appSettingRepository)
        {
            ...
            _currentThemeName = configuration[PlanConstants.ThemeConfigKey];
        }
        ...
        {
            var themeSetting = await _appSettingRepository.Query().Where(x => x.Id == PlanConstants.ThemeConfigKey).FirstAsync();
